package com.example.firebasereadwriteweek6;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://fir-authweek6-default-rtdb.firebaseio.com/");
        ...
        data_input = (EditText) findViewById(R.id.txtBox_Name);
        data_output = (TextView) findViewById(R.id.txt_Output);
